...
const EmployeeProfilePage: React.FC = () => {
  ...
  return (
    <div className="h-[calc(100vh-100px)] bg-gray-50 font-sans p-4 sm:p-6 md:p-8 overflow-auto custom-scrollbar">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="flex flex-wrap justify-around items-center mt-4 gap-4">
              <div className="flex flex-col items-center text-center">
                ...
                {/* <span className="text-sm text-gray-700 font-medium">{staffMember.employmentType || 'N/A'}</span> */}
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                {/* <span className="text-sm text-gray-700 font-medium">{staffMember.occupationArea || 'N/A'}</span> */}
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                {/* <span className="text-sm text-gray-700 font-medium">{staffMember.occupationLocation || 'N/A'}</span> */}
              </div>
            </div>
          </div>
